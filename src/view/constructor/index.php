...
<div class="poppup pop-changeMap" ng-show="showChangeMap">
    <div class="pop-container">
        <input id="close-changemap-pop" type="button" ng-click="showPoppup = false; showChangeMap = false;" hidden/>
        <div class="img" ng-repeat="url in lvls_urls" ng-click="map.map = url;" onclick="$('#close-changemap-pop').click()">
            <div>
    ...
    <form id="upload-image" enctype="multipart/form-data" hidden>
     <input type="file" multiple="multiple" accept=".txt,image/*" id="loadMap"/>
    </form>
...
<div class="container">
    <div id="top-panel">
        <div id="makeLevel">
            ...
            <button title="Изменить размер блока" style="background-image: url('/public/img/panel-icons/resizeIcon.png');" ng-click="remakeLvl='resizeColl'"></button>
            <button title="Добавить расположение игрока" style="background-image: url('/public/img/panel-icons/player.png');" ng-click="remakeLvl='addPlayer'"></button>
        </div>
...
<!--            </div>-->
    ...
    <div id="right-panel">
        ...
        <div class="editLvl">
            ...
            <div class="cls"></div>
            <input type="button" value="Выбрать мапу" ng-click="showPoppup = true;showChangeMap = true;" />
        </div>
